...
[SerializeField] Sprite emptyWhiteSprite;
    ...
    void HandleTips()
    {
        ...
        else if(tutorialState == 1)babySitter.ShowUpTipTutorial("I'm Robotip, your favourite fellow.");
        else if(tutorialState == 2)babySitter.ShowUpTipTutorial("In this short tutorial, I will try to teach you the game mechanics.");
        ...
        else if(tutorialState == 5)babySitter.ShowUpTipTutorial("Your turn ! Click to your pawn to move");
        else if(tutorialState == 6)babySitter.ShowUpTipTutorial("Great ! Now you can see the little circles on the movable blocks");
        else if(tutorialState == 7)babySitter.ShowUpTipTutorial("In setup phase, you can move your pawns in 2'nd row.");
        ...
        else if(tutorialState == 10)babySitter.ShowUpTipTutorial("Click to your knight to move");
        else if(tutorialState == 11)babySitter.ShowUpTipTutorial("In setup phase, you can move you nonpawn pieces in first row");
        else if(tutorialState == 12)babySitter.ShowUpTipTutorial("Move your knight to shown location.");
        ...
        else if(tutorialState == 19)babySitter.ShowUpTipTutorial("Notice that the legal movable blocks indicated slightly different.");
        else if(tutorialState == 20)babySitter.ShowUpTipTutorial("Now make a legal move to shown location");
        ...
        else if(tutorialState == 24)babySitter.ShowUpTipTutorial("That was a correct guess. Anyway we killed a piece.");
        else if(tutorialState == 25)babySitter.ShowUpTipTutorial("Oppenent's turn. Wait for your opponent to move.");
        else if(tutorialState == 26)babySitter.ShowUpTipTutorial("Opponent made the move. Now it is time to make a decision.");
        else if(tutorialState == 27)babySitter.ShowUpTipTutorial("Claim done by the opponent shown at top of the moved piece");
        ...
        else if(tutorialState == 31)babySitter.ShowUpTipTutorial("Let's see whether the move was bluff or not.");
        ...
        else if(tutorialState == 38)babySitter.ShowUpTipTutorial("Because you cannot move your pawns after the round start.");
        ...
        else if(tutorialState == 45)babySitter.ShowUpTipTutorial("To make a legal move with your king, you have to press Claim King button");
        ...
        else if(tutorialState == 49)babySitter.ShowUpTipTutorial("Kill that rook !");
        ...
        else if(tutorialState == 52)babySitter.ShowUpTipTutorial("It is opponent's turn. Wait your opponent to move.");
        else if(tutorialState == 53)babySitter.ShowUpTipTutorial("Opponent moved. Now use pass button");
        else if(tutorialState == 54)babySitter.ShowUpTipTutorial("It is your turn. Click to your bomb to move.");
        else if(tutorialState == 55)babySitter.ShowUpTipTutorial("Attack to shown location !");
        ...
        else if(tutorialState == 63)babySitter.ShowUpTipTutorial("We blowed it up with our bomb.");
        else if(tutorialState == 64)babySitter.ShowUpTipTutorial("We win the round as we killed opponent's king");
        else if(tutorialState == 65)babySitter.ShowUpTipTutorial("Who wins 2 rounds, wins the game.");
        else if(tutorialState == 66)babySitter.ShowUpTipTutorial("Last one more important tip");
        ...
        else if(tutorialState == 70)babySitter.ShowUpTipTutorial("3-One of the sides' king reveal");
